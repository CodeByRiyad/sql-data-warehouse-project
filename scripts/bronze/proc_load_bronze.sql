...
Script Purpose:
  ...
  It performs the following actions:
    -Truncated the table before loading data to avoid duplicate entries.
    - Uses the BULK INSERT command to load data from CSV files to bronze tables.

Parameters:
  - None. This stored procedure doesn't take any parameters.
...
BEGIN
	...
	@t_start_time DATETIME, @t_end_time DATETIME;
	BEGIN TRY
		...
		PRINT('------------------------------------------------------');
		PRINT('Succesfull Data Insertation Done');
		PRINT('------------------------------------------------------');
